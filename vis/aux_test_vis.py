...
from utils.postprocess import filter_pred, filter_pred_nms_free
...
class Vis():
    ...
    def update_scan(self):
        ...
        #boxes = filter_pred_nms_free(pred["reg_map"], pred["cls_map"], self.config[data["dtype"][0]], score_threshold=0.1, nms_threshold=0.8)
        #print(boxes.shape)
