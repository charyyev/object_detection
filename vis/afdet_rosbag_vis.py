...
class Vis():
    ...
    def update_scan(self, event):
        ...
        threshold = torch.tensor([0.4, 0.35, 0.5, 0.5])
...
if __name__ == "__main__":
    bag_file = "/home/stpc/rosbags/pangyo_2022-07-09-14-31-45.bag"
    bag_name = bag_file.split("/")[-1].split(".")[0]
    with open("/home/stpc/proj/object_detection/configs/afdet_half_range.json", 'r') as f:
        config = json.load(f)

    #model_path = "/home/stpc/experiments/afdet_reasonable_1-07-2022_1/checkpoints/15epoch"
