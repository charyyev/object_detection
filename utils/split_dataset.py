...
def split(datas, percents, save_folder):
    ...
    for data in datas.keys():
        ...
        write_to_file(os.path.join(save_folder, "reasonable_train.txt"), train_set, data)
        write_to_file(os.path.join(save_folder, "reasonable_val.txt"), val_set, data)
...
if __name__ == "__main__":
    ...
    percents = {"jrdb": 30, "small_robot": 90, "wego": 90, "nuscenes": 30, "lyft": 10}
