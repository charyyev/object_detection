...
# Crop kitti pointcloud so that only area visible from left camera remains
# Taken from https://github.com/gkadusumilli/Voxelnet/blob/master/crop_data/crop.py
...
#IMG_ROOT = '/home/stpc/data/kitti/image_2/training/image_2/'
PC_ROOT = '/home/stpc/data/kitti/velodyne/training/velodyne/'
PC_REDUCED_ROOT = '/home/stpc/data/kitti/velodyne/training_reduced/velodyne/'
CALIB_ROOT = '/home/stpc/data/kitti/calib/training/calib/'
...
for frame in range(0, 7481):
    ...
    output_name = PC_REDUCED_ROOT + '%06d' % frame + '.bin'
